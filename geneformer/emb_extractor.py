...
def get_embs(
    ...
    total_batch_length = len(input_ids)
    ...
    if summary_stat is None:
        ...
        example = input_ids[0]
        emb_dims = test_emb(model, example, layer_to_quant)
    ...
    for i in range(0, total_batch_length, forward_batch_size):
        ...
        del outputs
        del minibatch_input_data
        del minibatch_length
        del embs_i
        del mean_embs
...
class EmbExtractor:
    ...
    def extract_embs(
        ...
        raise NotImplementedError(
            "Due to function signature change (get_embs), this method is broken"
        )
